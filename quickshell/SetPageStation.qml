    ...
    SetCard {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                border.color: nameIn.activeFocus ? Theme.paintLayers.glacier[0] : Theme.paintLayers.glacier[4]
                TextInput {
                    id: nameIn
                    anchors.fill: parent
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                border.color: wallIn.activeFocus ? Theme.paintLayers.glacier[0] : Theme.paintLayers.glacier[4]
                TextInput {
                    id: wallIn
                    anchors.fill: parent
                    anchors.margins: Theme.s3
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                border.color: labelIn.activeFocus ? Theme.paintLayers.glacier[0] : Theme.paintLayers.glacier[4]
                TextInput {
                    id: labelIn
                    anchors.fill: parent
                    anchors.margins: Theme.s3
            ...
            Rectangle {
                ...
                border.color: whatIn.activeFocus ? Theme.paintLayers.glacier[0] : Theme.paintLayers.glacier[4]
                TextInput {
                    id: whatIn
                    anchors.fill: parent
                    anchors.margins: Theme.s3
